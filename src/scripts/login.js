...
function register() {
    ...
    let ErrosSL = () => {
        ...
        if( inputPasswordL.value.length == 0 || ErrosEL == true )
        {
            console.log(percorrerEmail);

            erroSL.innerHTML = '<span> * </span>';
            
            erroSL.style.color = 'red';
            
            inputPasswordL.style.backgroundColor = 'rgba(255, 6, 31, 0.16)';
        ...
        else
        {
            ...
            inputPasswordL.style.backgroundColor = 'white';
    ...
    inputPassword.oninput = ErrosSL;

    //registro

    inputUser.onchange = preencher;
    inputPassword.onchange = preencher;
...
//                             if( inputPassword.value.length >= 8 && equidadeSenhas() == true)
//                                 {
//                                     btnRegistrar.disabled = false;
//                                 }
                            
//                         }                   
//                         console.log(equidadeSenhas());
//                         console.log('u');
...
//                                 if( inputPassword.value.length >= 8 && percorrerSenha() == true && equidadeSenhas() == true )
//                                 {
//                                     btnRegistrar.disabled = false;
//                                 }
...
//     inputPasswordL.oninput = ErrosSL;
